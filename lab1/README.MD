...
<a href="#Завдання">Завдання</a>
<a href="#Вміст-xsl-файлу">Вміст файлу XSL</a>
<a href="#Текст-програми">Програмний код</a>
<a href="#Копії-екранних-форм">Копії екранних форм</a>
<a href="#Вміст-xhtml-файлу">Вміст XHTML-файлу</a>
## Завдання 
